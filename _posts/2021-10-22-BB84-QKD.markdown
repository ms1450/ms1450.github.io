...
image:
  ...
  alt: Detailed diagram of the system with photon emitter, receiver, and other quantum communication elements. The schematic includes annotations for better understanding of the technical aspects.
---
